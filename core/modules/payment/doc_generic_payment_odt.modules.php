...
require_once 'modules_payment.php';
 ...
 */
class doc_generic_payment_odt extends ModelePDFPayment
{
	/**
	 * Issuer
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "ODT/ODS template";
		$this->description = $langs->trans("DocumentModelOdt");
		$this->scandir = 'PAYMENT_ADDON_PDF_ODT_PATH'; // Name of constant that is used to save list of directories to scan
