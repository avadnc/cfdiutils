...
/**
 *  \file       htdocs/core/modules/facture/doc/pdf_cfdisponge.modules.php
 *  \ingroup    facture
 *  \brief      File of class to generate customers invoices from cfdisponge model
 */
...
/**
 *	Class to manage PDF invoice template cfdisponge
 */
class pdf_cfdisponge extends ModelePDFCfdifactures
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "cfdisponge";
		$this->description = $langs->trans('PDFCFDISpongeDescription');
