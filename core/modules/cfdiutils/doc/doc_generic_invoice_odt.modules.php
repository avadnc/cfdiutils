 ...
 */
class doc_generic_invoice_odt extends ModelePDFCfdifactures
{
	/**
	 * Issuer
	...
	public function __construct($db)
	{
		...
		$this->scandir = 'CFDIUTILS_ADDON_PDF_ODT_PATH'; // Name of constant that is used to save list of directories to scan
	...
	public function info($langs)
	{
		...
		$texte .= '<input type="hidden" name="param1" value="CFDIUTILS_ADDON_PDF_ODT_PATH">';
		$texte .= '<table class="nobordernopadding" width="100%">';

		// List of directories area
		$texte .= '<tr><td valign="middle">';
		$texttitle = $langs->trans("ListOfDirectories");
		$listofdir = explode(',', preg_replace('/[\r\n]+/', ',', trim($conf->global->CFDIUTILS_ADDON_PDF_ODT_PATH)));
		$listoffiles = array();
		...
		$texte .= $conf->global->CFDIUTILS_ADDON_PDF_ODT_PATH;
		$texte .= '</textarea>';
		...
		if (!empty($conf->global->CFDIUTILS_ADDON_PDF_ODT_PATH)) {
		...
		$texte .= '<input type="hidden" value="CFDIUTILS_ADDON_PDF_ODT_PATH" name="keyforuploaddir">';
