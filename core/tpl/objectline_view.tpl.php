...
//Load class cfdiproduct
dol_include_once('/cfdiutils/class/cfdiproduct.class.php');
...
$text .= " - <strong>Info SAT(</strong> UMED: " . $cfdiproduct->umed . " - Claveprodserv: ". $cfdiproduct->claveprodserv."<strong>)</strong>";
