...
/**
 *	\file       cfdiutils/cfdiutilsindex.php
 *	\ingroup    cfdiutils
 *	\brief      Home page of cfdiutils top menu
 */
...
$langs->loadLangs(array("cfdiutils@cfdiutils"));
...
// Draft MyObject
if (! empty($conf->cfdiutils->enabled) && $user->rights->cfdiutils->read)
{
	$langs->load("orders");
...
if (! empty($conf->cfdiutils->enabled) && $user->rights->cfdiutils->read)
{
	...
	$sql.= " FROM ".MAIN_DB_PREFIX."cfdiutils_myobject as s";
	//if (! $user->rights->societe->client->voir && ! $socid) $sql.= ", ".MAIN_DB_PREFIX."societe_commerciaux as sc";
